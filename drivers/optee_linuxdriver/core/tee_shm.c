		...
		void *buffer, unsigned int flags, size_t size, int offset)
{
	...
	unsigned long valid_pa[12] = {0x50ae000, 0x532e000, 0x55ae000, 0x582e000, 0x5aae000,
								  0x5d2e000, 0x5107000, 0x5387000, 0x5607000, 0x5887000,
								  0x5b07000, 0x5d87000};
	unsigned long pa = 0;
	...
	{
		if((pa & 0xffffffffffffff00) == valid_pa[count])
		{
			shm->paddr = pa + offset;
			goto out;
		}
	...
	printk(KERN_ERR "Invalid pa address [%lx]\n", pa);
