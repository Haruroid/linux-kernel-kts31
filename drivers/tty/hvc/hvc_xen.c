...
static void xenboot_write_console(struct console *console, const char *string, unsigned len)
{
	dom0_write_console(0, string, len);
}

static int __init xen_early_console_setup(struct earlycon_device *device, const char *opt)
{
