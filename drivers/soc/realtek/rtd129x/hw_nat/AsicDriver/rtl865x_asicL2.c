...
uint8 hwnat_rgmii_voltage; /* 1:1.8V, 2:2.5V, 3:3.3V */
#endif //defined(CONFIG_RTD_1295_HWNAT)
...
#if defined(CONFIG_RTL819X_GPIO) && defined(CONFIG_RTL_8367R_SUPPORT)
...
void initAsic_PHY(void)
{
	...
	if (hwnat_mac0_enable == 1 && hwnat_mac0_mode == 0 /*RGMII*/) {
		WRITE_MEM32(PCRP0, 	(READ_MEM32(PCRP0) & ~(ExtPHYID_MASK | EnForceMode | PollLinkStatus | PauseFlowControl_MASK)) |
		...
		WRITE_MEM32(PCRP0, 	(READ_MEM32(PCRP0) & ~(EnForceMode | PollLinkStatus | PauseFlowControl_MASK)) |
				NwayAbility1000MF |
				NwayAbility100MF |
				NwayAbility100MH |
				NwayAbility10MF |
	...
	//turn on all advertise abilities,
	//enable PHY interface of MAC4
	WRITE_MEM32(PCRP4, 	(READ_MEM32(PCRP4) & ~(EnForceMode | PollLinkStatus | PauseFlowControl_MASK)) |
				NwayAbility1000MF |
				NwayAbility100MF |
				NwayAbility100MH |
				NwayAbility10MF |
	...
	if (hwnat_mac5_conn_to == 0 /* PHY */) {
		...
		//turn on all advertise abilities,
		//enable PHY interface of MAC5
		WRITE_MEM32(PCRP5, (READ_MEM32(PCRP5) & ~(ExtPHYID_MASK | EnForceMode | PollLinkStatus | PauseFlowControl_MASK)) |
				(rtl8651AsicEthernetTable[5].phyId << ExtPHYID_OFFSET) |
				NwayAbility1000MF |
				NwayAbility100MF |
				NwayAbility100MH |
		...
		WRITE_MEM32(PCRP5, (READ_MEM32(PCRP5) & ~(ExtPHYID_MASK | ForceSpeedMask | PollLinkStatus | PauseFlowControl_MASK)) |
				(rtl8651AsicEthernetTable[5].phyId << ExtPHYID_OFFSET) |
				EnForceMode |
				ForceLink |
				ForceSpeed1000M |
		...
		//set rx delay as 4 (2ns)
		WRITE_MEM32(P5GMIICR, (READ_MEM32(P5GMIICR) & ~(7 << 0)) | (4 << 0));
	}
