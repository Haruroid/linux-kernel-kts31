...
#else
#define CPU_IFACE_BASE			((unsigned int) rtl_hwnat_mmio + HWNAT_CPUIR_OFFSET)
#define REAL_SWCORE_BASE		CPU_IFACE_BASE
//#define REAL_SYSTEM_BASE		0x981B0000
#define REAL_HSA_BASE			((unsigned int) rtl_hwnat_mmio + HWNAT_DDR2_OFFSET)
#define REAL_HSB_BASE			(REAL_HSA_BASE + 0x80)
//#define REAL_SWTBL_BASE			((unsigned int) rtl_hwnat_mmio + HWNAT_SWTBL_OFFSET)
#define SW_SWTBL_BASE			((unsigned int) rtl_hwnat_mmio + HWNAT_SWTBL_OFFSET)
#define HW_SWTBL_BASE			(rtl_hwnat_base + HWNAT_SWTBL_OFFSET)
#endif
